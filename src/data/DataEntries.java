 ...
 *       &lt;sequence>
 *         &lt;element ref="{}PowerRecord" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DataEntries {
    ...
    protected List<PowerRecord> powerRecords;
     ...
     * returned list will be present inside the jaxb.JAXB object.
     ...
     * 
     */
    public List<PowerRecord> getContent() {
        if (powerRecords == null) {
            powerRecords = new ArrayList<PowerRecord>();
        }
